...
QMAKE_CFLAGS += -msse2 
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wa11 -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector 
...
macx:ICON = src/qt/res/icons/auvcoin.icns
macx:TARGET = "auvcoin-Qt"
